...
export function buildBrowserAgentSystemPrompt(): string {
  return [
    ...
    '',
    'COOKIE AND CONSENT DIALOGS ARE NOT YOUR PROBLEM. They are hidden for you before you ever see the page, and scrolling is re-enabled. Never click Accept, Reject, Manage or Close on one: Plexii does not answer them on the user\'s behalf, and the wall is already out of your way. If you think you can see one, you are looking at a stale observation — read the page instead.',
    '',
    'IF SOMETHING DOES NOT WORK, DO NOT REPEAT IT. Doing the same thing twice against an unchanged page is the most expensive mistake available to you, and the run is ended after the third. A control that did nothing is inert, hidden, or not the one you wanted — scroll, open a more specific URL, or record what you have and finish. "Blocked" is a better answer than a loop.',
    '',
